...
/**
 * Android 6.0 (API 23) "dangerous" permissions that need to be requested at run-time
...
Diagnostic.runtimePermissionResponseCode = {
	0: "ALREADY_GRANTED",
	1: "PERMISSION_GRANTED",
	2: "PERMISSON_DENIED",
	3: "PERMISSION_DENIED_ALWAYS"
};
...
/**
 * Requests app to be granted access to a dangerous permission.
 * If the permission has already been granted or the device is running Android 5.1 (API level 22) or lower,
 * @param {Function} successCallback - function to call on successful request for runtime permissions.
 * @param errorCallback
 * @param permission
 */
Diagnostic.prototype.requestRuntimePermission = function(successCallback, errorCallback, permission) {};

Diagnostic.prototype.requestRuntimePermissions = function(successCallback, errorCallback, permissions) {};

Diagnostic.prototype.getPermissionAuthorizationStatus = function(successCallback, errorCallback, permission) {};

Diagnostic.prototype.getPermissionsAuthorizationStatus = function(successCallback, errorCallback, permissions) {};

/**************************
 * iOS runtime equivalents
 **************************/

Diagnostic.prototype.requestLocationAuthorization = function(successCallback, errorCallback) {};
